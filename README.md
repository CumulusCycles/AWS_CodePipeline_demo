# AWS CodePipeline
Code and Commands for the AWS CodePipeline [video](https://www.youtube.com/watch?v=dMpIdIIIWCc).

## CodeCommit
```
aws codecommit create-repository --repository-name YOUR_REPO_NAME --repository-description "Repo for CodePipeline demo"
```
